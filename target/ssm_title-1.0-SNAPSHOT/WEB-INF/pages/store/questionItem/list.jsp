    ...
    <script type="text/javascript">
        function deleteById(id) {
            ...
            if(confirm("你确认要删除此条记录吗？")) {
                window.location.href="${ctx}/store/questionItem?operation=delete&id="+id +"&questionId=${questionId}";
            }
        }
        function deleteById() {
            var id = getCheckId()
            if(id) {
                if(confirm("你确认要删除此条记录吗？")) {
                    location.href="${ctx}/store/questionItem?operation=delete&id="+id+"&questionId=${questionId}";
                }
            }else{
...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/store/questionItem?operation=${operation}&id=${questionId}&itemId=${questionItem.id}" method="post" enctype="multipart/form-data">
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <input type="file" class="form-control" placeholder="请选择" name="picture" value="${questionItem.picture}" >
                    </div>
                ...
                <div class="table-box">
                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default" title="新建" onclick='location.href="${ctx}/store/questionItem?operation=toAdd&id=${questionId}"'><i class="fa fa-refresh"></i> 新建</button>
<%--                                <button type="button" class="btn btn-default" title="新建" onclick='location.href="${ctx}/store/questionItem?operation=toAdd"'><i class="fa fa-file-o"></i> 新建</button>--%>
            ...
            <div class="box-footer">
                <jsp:include page="../../common/page.jsp">
                    <jsp:param value="${ctx}/store/questionItem?operation=list&id=${questionId}" name="pageUrl"/>
                </jsp:include>
            </div>
        </div>

    </section>
    <c:if test="${questionItem.picture.length()> 0}">

        <div class="col-md-2 title">题干图片</div>
        <div class="col-md-10 data ">
            <img  src="${ctx}/upload/${questionItem.picture}" height="500" width="500">
