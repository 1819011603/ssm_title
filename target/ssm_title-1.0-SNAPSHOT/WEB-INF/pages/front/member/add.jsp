            ...
            <div class="box-body">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="#tab-form" data-toggle="tab">会员账号新建</a>
                        </li>
                    </ul>
                                ...
                                <div class="row data-type">
                                    ...
                                    <div class="col-md-10 data">
                                        <div class="input-group date">
                                            ...
                                            <input type="text"   name="birthday"  placeholder="yyyy-mm-dd" class="form-control pull-right"
                                    ...
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" placeholder="电话号码" name="telephone" value="${member.telephone}">
                                    </div>
