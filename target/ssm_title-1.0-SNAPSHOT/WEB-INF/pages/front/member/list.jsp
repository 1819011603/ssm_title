            ...
            <div class="table-box">
                ...
                <div class="pull-left">
                    <div class="form-group form-inline">
                        <div class="btn-group">
                            <c:if test="${sessionScope.authorList.contains('front/member?operation=toAdd')}">
                            <button type="button" class="btn btn-default" title="新建" onclick='location.href="${ctx}/front/member?operation=toAdd"'><i class="fa fa-file-o"></i> 新建</button>
                            </c:if>
                    ...
                    <c:forEach items="${page.list}" var="member">
                        <tr>
                            ...
                            <th class="text-center">
                                <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${ctx}/front/member?operation=toEdit&id=${member.id}"'>编辑</button>
                            </th>
                        </tr>
                    </c:forEach>
                    </tbody>
