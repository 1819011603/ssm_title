                ...
                <div class="pull-left">
                    <div class="form-group form-inline">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-default" title="上传" onclick='location.href="${ctx}/store/question?operation=toUpload"'><i class="fa fa-file-o"></i> 上传</button>
                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                        ...
                        <th class="text-center">
                            ...
                            <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${ctx}/store/questionItem?operation=list&id=${o.id}"'>显示选项</button>
                        </th>
                    </tr>
                    </c:forEach>
                    </tbody>
